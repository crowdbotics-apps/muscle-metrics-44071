"""
Django settings for muscle_metrics_44071 project.
...
ROOT_URLCONF = 'muscle_metrics_44071.urls'
...
WSGI_APPLICATION = 'muscle_metrics_44071.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muscle_metrics_44071 API",
    "DESCRIPTION": "API documentation for muscle_metrics_44071 App",
    "VERSION": "v1",
}
